<?php 
    ...
    if(isset($_POST['fullname']) &&  isset($_POST['email']) &&  isset($_POST['subject']) &&  isset($_POST['message']) ){
        ...
        $q = $db->prepare("INSERT INTO messages SET fullname=:fullname, email=:email, subject=:subject,message=:message");
                    ...
                    <form action="contact.php" method="POST">
                                ...
                                <!-- <?php   
                                    if(isset($_GET['msg'])){
                                        ...
                                        if($_GET['msg']==1){
                                            echo "<h6 style='color:blue'> <b>Message sent! </b> </h6>";
                                        }elseif($_GET['msg']==2){
                                            echo "<h6 style='color:red'> <b> error message not sents! </b> </h6>";
